                ...
                If LCase(Left(File, 5)) <> "robot" Then
                    ...
                    For i = 1 To nTables
                        ...
                        For j = 1 To ntabs
                            ...
                            Dim match As Match = tFilter.Match(tabname)
                            If match.Success Then
                                Console.WriteLine("Table duplicate not printed" & vbCrLf)
                            Else
                                If Trim(FName) = "Reactions" Then 'Or Trim(FName) = "Stresses" Then 'We want the reactions and stresses envelope, it's more compact
                                    ...
                                    If tabname = "Envelope" Then
                                        ...
                                        Console.WriteLine($"Writing tab {tabname} of table {FName} for tag {Tag}" & vbCrLf)
                                    End If
